const permissions = {
    ...
    group: ["stories", null, "photos", null, null, null, "app_widget", null, null, null, null, null, "messages", null, null, null, null, "docs", "manage"],
}
...
const decodeBitMask = (bitMask, permArray) => {
    ...
    let binMaskArray = [...binMaskString]
...
module.exports = { permissions, decodeBitMask }